    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>
          PERFIL DO <Text style={styles.textNeon}>MC</Text>
        </Text>
        <View style={{ width: 28 }} />{" "}
      ...
      >
        ...
        <View style={styles.profileInfo}>
          <Image
            source={{ uri: MC_PUBLIC_DATA.avatar }}
            style={styles.avatar}
          />
          ...
          <View style={styles.rankingBadge}>
            ...
            <Text style={styles.rankingText}>
              Top {MC_PUBLIC_DATA.rankingPos} Nacional
            </Text>
          </View>
        </View>
