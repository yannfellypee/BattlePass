...
// Dados simulados. Experimente mudar o 'role' para 'Organizer' para ver a mágica da interface mudar!
const USER_DATA = {
  username: 'yannfellype_',
  name: 'Yann Fellype',
  artisticName: 'MC Kaos',
  role: 'MC', // Pode ser 'Public', 'MC' ou 'Organizer'
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        {/* RENDERIZAÇÃO CONDICIONAL: O QUE MOSTRAR BASEADO NO TIPO DE USUÁRIO */}
